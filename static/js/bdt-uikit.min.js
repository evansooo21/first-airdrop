...
(function(we, $e) {
    typeof exports == "object" && typeof module < "u" ? module.exports = $e() : typeof define == "function" && define.amd ? define("uikit", $e) : (we = typeof globalThis < "u" ? globalThis : we || self, we.bdtUIkit = $e())
})(this, function() {
    "use strict";
    const {
        hasOwnProperty: we,
    ...
    function R(...t) {
        const [e, i, s, n, o = !1, r] = Gi(t), a = $(e, i, s, l => {
            const h = !r || r(l);
            h && (a(), n(l, h))
        }, o);
        return a
    ...
    function Vs(t, e, i = 200, s, n) {
        return Promise.all(T(t).map(o => new Promise((r, a) => {
            ...
            R(o, [Us, oi], ({
                ...
                self: !0
            }), c(o, "animationDuration", `${i}ms`), b(o, e, Ae + (n ? "leave" : "enter")), ut(e, Ae) && (s && b(o, `bdt-transform-origin-${s}`), n && b(o, `${Ae}reverse`))
        })))
    }
    ...
    function x(t) {
        const e = ye(t) ? F(t).getBoundingClientRect() : {
            height: tt(t),
            width: De(t),
            top: 0,
            left: 0
    ...
    function xr() {
        return Be || (le || (le = w("<div>"), c(le, {
            height: "100vh",
            position: "fixed"
        }), $(window, "resize", () => Be = null)), H(document.body, le), Be = le.clientHeight, at(le), Be)
    }
    ...
    function Fe(t, e, i) {
        const s = {};
        if (et(e) && (e = e.options), e.extends && (t = Fe(t, e.extends, i)), e.mixins)
    ...
    function fe(t, e = []) {
        try {
            return t ? ut(t, "{") ? JSON.parse(t) : e.length && !m(t, ":") ? {
                [e[0]]: t
            } : t.split(";").reduce((i, s) => {
                const [n, o] = s.split(/:(.*)/);
    ...
    function He(t, e = "update") {
        t._connected && t._updates.length && (t._queued || (t._queued = new Set, X.read(() => {
    ...
    function jr(t, e) {
        for (const {
            ...
            let o;
            i && (o = i.call(t, t._data, e), o && xt(o) && pt(t._data, o)), s && o !== !1 && X.write(() => {
    ...
    var xn = {
        ...
        update: {
            ...
            write({
                ...
                for (const e of t)
                    for (const i of e) j(i, this.margin, t[0] !== e), j(i, this.firstColumn, e[U ? e.length - 1 : 0] === i)
            },
            events: ["resize"]
        }
    };
    ...
    const bs = "bdt-transition-leave",
        ws = "bdt-transition-enter";
    ...
    function yn(t, e, i, s = 0) {
        const n = vi(e, !0),
            ...
            h = a(async () => {
                ...
                u !== d && y.push(M.start(e, {
                    height: d
                }, i / 2 + g.length * s, "ease")), await Promise.all(y).then(() => {
                    O(e, ws), n === vi(e) && (c(e, {
                        height: "",
                        alignContent: ""
                    }), c(f, {
    ...
    function Xr(t, e, i) {
        const s = e.map((o, r) => E(o) && r in i ? i[r] ? W(o) ? Cn(o) : {
                opacity: 0
            } : {
                opacity: W(o) ? 1 : 0
            } : !1),
    ...
    function _n(t, e, i) {
        ...
        return (s || G(o)) && (n ? s ? (delete i.filter[""], i.filter[n] = s) : (delete i.filter[n], (Se(i.filter) || "" in i.filter) && (i.filter = {
            "": s || ""
        })) : i.filter = {
            "": s || ""
        }), G(o) || (i.sort = [o, r]), i
    ...
    function ia(t, e, i) {
        return [...t].sort((s, n) => Y(s, e).localeCompare(Y(n, e), void 0, {
            numeric: !0
        }) * (i === "asc" || -1))
    }
    ...
    async function oa(t, e, {
        ...
        const [l = "reveal", h = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [], u = [
            ["left", "right"],
            ["top", "bottom"]
        ], f = u[m(u[0], h) ? 0 : 1], d = f[1] === h, y = ["width", "height"][u.indexOf(f)], C = `margin-${f[0]}`, D = `margin-${h}`;
        let wt = x(t)[y];
        ...
        d && (c(t, C, Zt - wt + be), Go[C] = e ? be : Zt + be), !d ^ l === "reveal" && (c(Di, C, -Zt + wt), M.start(Di, {
            [C]: e ? 0 : -Zt
        }, s, o));
        try {
    ...
    function ha(t) {
        return $(document, gt, ({
            ...
            se(nt) !== t || t.overlay && !t.$el.contains(e) || t.panel.contains(e) || R(document, `${At} ${fi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    function ua(t, e, i, {
        ...
        return {
            ...
            show(u, f = 0, d) {
                const g = d ? "linear" : n;
                return u -= Math.round(u * Z(f, -1, 1)), this.translate(f), bi(e, "itemin", {
                    percent: f,
                    duration: u,
                    timing: g,
                    dir: i
            ...
            translate(u) {
                this.reset();
                const f = r(u, i);
                c(e, f[1]), c(t, f[0]), bi(e, "itemtranslatein", {
                    percent: u,
                    dir: i
        ...
        methods: {
            ...
            move(t) {
                ...
                let {
                    slides: i,
                    prevIndex: s
                } = this, n = Math.abs(e), o = this.getIndex(s + this.dir), r = this._getDistance(s, o);
    ...
    function va(t, e) {
        for (const {
                ...
                handler: s,
                immediate: n = !0
            } of t._watches)(t._initial && n || dt(e, i) && !ti(e[i], t[i])) && s.call(t, t[i], e[i]);
        t._initial = !1
    }
    ...
    function xa() {
        Is || (qe = new Set, Is = new MutationObserver(() => {
    ...
    function Fn(t, e, i) {
        ...
        n = et(n) ? n.call(t, t) : n || t.$el, !(!n || K(n) && !n.length || h && !h.call(t)) && t._events.push($(n, s, l ? N(l) ? l : l.call(t, t) : null, N(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: u
        }))
    ...
    function Fa(t) {
        t.prototype.$mount = function(e) {
            ...
            Ts(this), Cs(this)
        }, t.prototype.$getComponent = $i, Object.defineProperties(t.prototype, {
            $el: {
                get() {
        ...
        Jn = {
            ...
            events: [{
                ...
                async handler(t, e) {
                    ...
                    } else if (s === "iframe" || i.match(/\.(html|php)($|\?)/i)) this.setItem(e, Ve("iframe", {
                        src: i,
                        allowfullscreen: "",
                        class: "bdt-lightbox-iframe",
                        ...r
                    }));
                    else if (a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) this.setItem(e, Ve("iframe", {
            ...
            methods: {
                ...
                showControls() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), b(this.$el, "bdt-active", "bdt-transition-active")
                },
                hideControls() {
    ...
    var qa = {
        ...
        created() {
            ...
            (!e || !W(e)) && (e = H(this.container, `<div class="${this.clsContainer} ${t}"></div>`)), this.$mount(H(e, `<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert"> <a href class="${this.clsClose}" data-bdt-close></a> <div>${this.message}</div> </div>`))
        },
        async connected() {
    ...
    function Va(t, e) {
        if (N(t)) {
            if (ut(t, "@")) t = k(c(e, `--bdt-breakpoint-${t.substr(1)}`));
    ...
    var Qa = {
        ...
        update: {
            read({
                ...
                const i = t;
                return t = tl(as(this.target, this.start, this.end), this.easing), {
                    percent: t,
    ...
    var sl = {
        ...
        methods: {
            ...
            getAdjacentSlides() {
                const {
                    width: t
                } = x(this.list), e = -t, i = t * 2, s = x(this.slides[this.index]).width, n = this.center ? t / 2 - s / 2 : 0, o = new Set;
                for (const r of [-1, 1]) {
                    let a = n + (r > 0 ? s : 0),
                        l = 0;
                    do {
    ...
    function nl(t, e) {
        ...
        for (const o in s) {
            ...
            if (h > Dt(s.filter(u => !l.has(u)), u => x(u).width)) return !0
        }
        return !1
    }
        ...
        ll = {
            ...
            methods: {
                init(t) {
                    ...
                    !n || s || i > 0 || ji(e) || e.closest(`.${this.clsNoDrag}`) || this.handle && !e.closest(this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = n, this.origin = {
                        target: e,
                        index: ne(n),
                        ...this.pos
                    }, $(document, ui, this.move), $(document, At, this.end), this.threshold || this.start(t))
                },
                start(t) {
                    ...
                    }), b(this.drag, this.clsDrag, this.clsCustom), b(this.placeholder, this.clsPlaceholder), b(this.items, this.clsItem), b(document.documentElement, this.clsDragState), v(this.$el, "start", [this, this.placeholder]), hl(this.pos), this.move(t)
                },
                move(t) {
    ...
    function ul(t, e) {
        ...
        return H(t, i), c(i, "margin", "0", "important"), c(i, {
            boxSizing: "border-box",
            width: e.offsetWidth,
            height: e.offsetHeight,
            padding: c(e, "padding")
    ...
    var bo = {
        ...
        methods: {
            ...
            getPositionOffset(t) {
                return Q(this.offset === !1 ? c(t, "--bdt-position-offset") : this.offset, this.axis === "x" ? "width" : "height", t) * (m(["left", "top"], this.dir) ? -1 : 1) * (this.inset ? -1 : 1)
            },
            getShiftOffset(t) {
                return this.align === "center" ? 0 : Q(c(t, "--bdt-position-shift-offset"), this.axis === "y" ? "width" : "height", t) * (m(["left", "top"], this.align) ? 1 : -1)
            },
            getViewportOffset(t) {
                return Q(c(t, "--bdt-position-viewport-offset"))
            }
        }
    };
    ...
    var ml = {
        ...
        methods: {
            ...
            async _show(t, e) {
                this.tooltip = H(this.container, `<div id="${e}" class="bdt-${this.$options.name}" role="tooltip"> <div class="bdt-${this.$options.name}-inner">${t}</div> </div>`), $(this.tooltip, "toggled", (i, s) => {
                    if (!s) return;
                    ...
                    const a = [R(document, `keydown ${gt}`, this.hide, !1, l => l.type === gt && !this.$el.contains(l.target) || l.type === "keydown" && l.keyCode === P.ESC), $([document, ...qt(this.$el)], "scroll", n, {
                        passive: !0
                    })];
    ...
    function kl(t, e) {
        return new Promise((i, s) => {
            ...
            }), $(n, "error", () => s(pt(Error("Network Error"), {
                xhr: n
            }))), $(n, "timeout", () => s(pt(Error("Network Timeout"), {
                xhr: n
            }))), n.send(e.data)
        })
    }
    ...
    function $o(t) {
        v(document, "uikit:init", t), document.body && It(document.body, xo), new MutationObserver(e => e.forEach(Cl)).observe(document, {
            subtree: !0,
            childList: !0
    ...
    async function Pl(t, e, {
        ...
        s = (n * h + s) * (e ? 1 - u : u), c(a, "height", l), await M.start(a, {
            height: e ? h : 0
        }, s, o), Me(i), delete t._wrapper, e || Pi(i, !0)
    }
    ...
    var To = {
        ...
        connected() {
            b(this.$el, "bdt-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = Nl(this)), this._style = Fi(this.$el.style, ["width", "height"])
        },
        disconnected() {
        ...
        methods: {
            ...
            position() {
                O(this.$el, "bdt-drop-stack"), c(this.$el, this._style), this.$el.hidden = !0;
                ...
                this.$el.hidden = !1, c(this.$el, "maxWidth", ""), this.$el.offsetWidth > s && b(this.$el, "bdt-drop-stack"), c(this.$el, "maxWidth", s), this.positionAt(this.$el, this.target, this.boundary);
    ...
    function Ll(t) {
        return $(document, gt, ({
            ...
            t.$el.contains(e) || R(document, `${At} ${fi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    var Po = {
        ...
        watch: {
            dropbar(t) {
                b(t, "bdt-dropbar", "bdt-dropbar-top", this.clsDropbar, `bdt-${this.$options.name}-dropbar`)
            },
            dropdowns() {
        ...
        events: [{
            ...
            handler({
                ...
                const e = this.getDropdown(t),
                    i = () => {
                        const s = Nt(t, `.${this.clsDrop}`).concat(t).map(a => S(a)),
                            n = Math.min(...s.map(({
                                top: a
                            }) => a)),
                            o = Math.max(...s.map(({
        ...
        methods: {
            ...
            async transitionTo(t, e) {
                ...
                e = s < t && e, await M.cancel([e, i]), c(e, "clipPath", `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`), tt(i, s), await Promise.all([M.start(i, {
                    height: t
    ...
    var Wl = {
        ...
        Rl = {
            ...
            connected() {
                this.masonry && b(this.$el, "bdt-flex-top", "bdt-flex-wrap-top")
            },
            observe: mi({
                filter: ({
                    parallax: t,
            ...
            update: [{
                ...
                read(t) {
                    ...
                    const h = a.map(y => Dt(y, "offsetHeight") + r * (y.length - 1)),
                        u = Math.max(0, ...h);
                    let f, d, g;
                    return (s || n) && (f = h.map((y, C) => n ? u - y + s : s / (C % 2 || 8)), n || (s = Math.max(...h.map((y, C) => y + f[C] - u))), d = Q(this.parallaxStart, "height", this.$el, !0), g = Q(this.parallaxEnd, "height", this.$el, !0)), {
                        columns: a,
                        translates: l,
                        scrollColumns: f,
                        parallaxStart: d,
        ...
        for (let a of t) {
            ...
            for (const h in a) {
                const {
                    offsetWidth: u,
                    offsetHeight: f
                } = a[h], d = i ? h : o.indexOf(Math.min(...o));
    ...
    var Xl = {
        ...
        sh = '<svg width="20" height="20" viewBox="0 0 20 20"><style>.bdt-navbar-toggle-animate svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.bdt-navbar-toggle svg&gt;.line-3{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect class="line-1" y="3" width="20" height="2"/><rect class="line-2" y="9" width="20" height="2"/><rect class="line-3" y="9" width="20" height="2"/><rect class="line-4" y="15" width="20" height="2"/></svg>',
    ...
    const _i = {
        ...
        wh = {
            ...
            beforeConnect() {
                if (this.icon = I(this.$el, "bdt-search-icon") && Nt(this.$el, ".bdt-search-large").length ? "search-large" : Nt(this.$el, ".bdt-search-navbar").length ? "search-navbar" : this.$props.icon, !kt(this.$el, "aria-label"))
                    if (I(this.$el, "bdt-search-toggle") || I(this.$el, "bdt-navbar-toggle")) {
        ...
        Do = {
            extends: Kt,
            beforeConnect() {
                b(this.$el, "bdt-slidenav");
                const t = this.$props.icon;
                this.icon = I(this.$el, "bdt-slidenav-large") ? `${t}-large` : t
            }
        },
        xh = {
            extends: Kt,
        ...
        yh = {
            ...
            beforeConnect() {
                this.icon = `close-${I(this.$el,"bdt-close-large")?"large":"icon"}`
            }
        },
        kh = {
            extends: Kt,
    ...
    var zh = {
        ...
        Fh = {
            ...
            events: [{
                ...
                self: !0,
                handler() {
                    I(this.panel, "bdt-margin-auto-vertical") ? b(this.$el, "bdt-flex") : c(this.$el, "display", "block"), tt(this.$el)
                }
            }, {
                name: "hidden",
                self: !0,
                handler() {
                    c(this.$el, "display", ""), O(this.$el, "bdt-flex")
                }
            }]
        };
    ...
    function Hh({
        ...
        t.dialog = function(i, s) {
            ...
            return e(({
                i18n: n
            }) => `<div class="bdt-modal-body">${N(i)?i:Ht(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>${n.ok}</button> </div>`, s)
        }, t.confirm = function(i, s) {
            return e(({
                i18n: n
            }) => `<form> <div class="bdt-modal-body">${N(i)?i:Ht(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${n.cancel}</button> <button class="bdt-button bdt-button-primary" autofocus>${n.ok}</button> </div> </form>`, s, () => Promise.reject())
        }, t.prompt = function(i, s, n) {
            const o = e(({
                    i18n: l
                }) => `<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>${N(i)?i:Ht(i)}</label> <input class="bdt-input" value="${s||""}" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${l.cancel}</button> <button class="bdt-button bdt-button-primary">${l.ok}</button> </div> </form>`, n, () => null, () => a.value),
                {
                    $el: r
                } = o.dialog,
                a = w("input", r);
    ...
    var Lh = {
        ...
        Wh = {
            ...
            computed: {
                ...
                dropbarOffset: ({
                    dropbarTransparentMode: t
                }, e) => t === "behind" ? e.offsetHeight : 0
            },
            watch: {
                items() {
                    const t = I(this.$el, "bdt-navbar-justify");
                    for (const e of z(".bdt-navbar-nav, .bdt-navbar-left, .bdt-navbar-right", this.$el)) c(e, "flexGrow", t ? z(".bdt-navbar-nav > li > a, .bdt-navbar-item, .bdt-navbar-toggle", e).length : "")
                }
            },
            disconnect() {
                var t;
            ...
            events: [{
                ...
                handler({
                    ...
                    const i = () => this._mode = Rh(this.navbarContainer, "bdt-light", "bdt-dark");
                    if (e === "behind") {
                        const s = No(this.$el);
                        s && (i(), b(this.navbarContainer, `bdt-${s}`))
                    }
                    e === "remove" && (i(), O(this.navbarContainer, "bdt-navbar-transparent"))
                }
            }, {
                name: "hide",
                el() {
                ...
                async handler({
                    ...
                    if (!(!e || !this._mode) && (await jh(), !this.getActive())) {
                        if (e === "behind") {
                            const i = No(this.$el);
                            i && O(this.navbarContainer, `bdt-${i}`)
                        }
                        b(this.navbarContainer, this._mode), e === "remove" && b(this.navbarContainer, "bdt-navbar-transparent"), this._mode = null
                    }
                }
            }],
            methods: {
                getTransparentMode(t) {
                    ...
                    const e = this.getDropdown(t);
                    if (!(!e || !I(t, "bdt-dropbar"))) return e.inset ? "behind" : "remove"
                },
                registerColorListener() {
                    const t = this._isIntersecting && I(this.navbarContainer, "bdt-navbar-transparent") && !Uh(this.navbarContainer) && !z(".bdt-drop", this.dropContainer).map(this.getDropdown).some(e => e.isToggled() && (e.inset || this.getTransparentMode(e.$el) === "behind"));
                    ...
                    t && (this._colorListener = qh(this.navbarContainer, () => {
                        const {
                            ...
                            top: i,
                            height: s
                        } = S(this.navbarContainer), n = {
                            x: e,
                            y: Math.max(0, i) + s / 2
                        }, o = z(this.selTransparentTarget).find(a => Ie(n, S(a))), r = c(o, "--bdt-navbar-color");
                        r && ii(this.navbarContainer, "bdt-light,bdt-dark", `bdt-${r}`)
                    }))
                }
            }
        };
    ...
    function No(t) {
        return c(t, "--bdt-navbar-dropbar-behind-color")
    }
    ...
    function Uh(t) {
        do
            if (c(t, "mixBlendMode") !== "normal") return !0; while (t = E(t))
    }
    var Vh = {
        mixins: [xs],
        args: "mode",
    ...
    var Xh = {
        ...
        Jh = {
            props: ["width", "height"],
            connected() {
                b(this.$el, "bdt-responsive-width")
            },
            observe: mt({
                target: ({
                    $el: t
        ...
        Kh = {
            ...
            methods: {
                async scrollTo(t) {
                    t = t && w(t) || document.body, v(this.$el, "beforescroll", [this, t]) && (await hn(t, {
                        offset: this.offset
    ...
    function Fo(t) {
        if (!t.defaultPrevented)
            for (const e of Je) e.$el.contains(t.target) && oe(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(qi(e.$el)))
    }
    var tc = {
            args: "cls",
            props: {
            ...
            observe: de({
                ...
                handler(t) {
                    ...
                    for (const {
                        ...
                        e.has(i) || e.set(i, {
                            cls: Y(i, "bdt-scrollspy-class") || this.cls
                        });
                        const n = e.get(i);
        ...
        ic = {
            ...
            connected() {
                this.start = Ho(this.start || this.top), this.end = Ho(this.end || this.bottom), this.placeholder = w("+ .bdt-sticky-placeholder", this.$el) || w('<div class="bdt-sticky-placeholder"></div>'), this.isFixed = !1, this.setActive(!1)
            },
            beforeDisconnect() {
            ...
            update: [{
                read({
                    ...
                    n && (Wo(this.$el), this.hide()), this.active || ({
                        height: t,
                        width: e
                    } = S(this.$el), i = c(this.$el, "margin")), n && this.show();
                    ...
                    return s = a && !this.showOnUp && y + u === d && C === Math.min(a, Ds("!*", this.$el, 0, !0) - g - u + f) && c(E(this.$el), "overflowY") === "visible", {
                        start: y,
                        end: C,
                        offset: u,
                        overflow: f,
                ...
                write({
                    ...
                    c(o, {
                        ...
                        width: e,
                        margin: i
                    }), document.contains(o) || (o.hidden = !0), (n ? ri : ai)(this.$el, o)
                },
                events: ["resize"]
            }, {
                read({
                    ...
                    if ((d - s > 300 || n !== o) && (t.initScroll = r, t.initTimestamp = d), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10))
                        if (this.inactive || r < h || this.showOnUp && (r <= h || n === "down" && i || n === "up" && !this.isFixed && r <= u + f)) {
                            ...
                            if (this.animation && r > u) {
                                if (I(this.$el, "bdt-animation-leave")) return;
    ...
    function Wo(t) {
        b(t, "bdt-transition-disable"), requestAnimationFrame(() => O(t, "bdt-transition-disable"))
    }
    var sc = {
        mixins: [Ao],
        args: "src",
    ...
    var qo = {
            ...
            events: [{
                ...
                handler(t) {
                    const {
                        current: e,
                        keyCode: i
                    } = t, s = A(this.$el, this.selVertical);
            ...
            update() {
                ...
                for (const e in this.toggles) {
                    ...
                    p(i, "role", "tab"), s && (i.id = Yt(this, i), s.id = Yt(this, s), p(i, "aria-controls", s.id), p(s, {
                        role: "tabpanel",
                        "aria-labelledby": i.id
                    }))
                }
        ...
        lc = {
            ...
            connected() {
                const t = I(this.$el, "bdt-tab-left") ? "bdt-tab-left" : I(this.$el, "bdt-tab-right") ? "bdt-tab-right" : !1;
    ...
    var cc = {
            ...
            events: [{
                ...
                handler(t) {
                    this._preventClick = null, !(!St(t) || ee(this._showState) || this.$el.disabled) && (v(this.$el, "focus"), R(document, gt, () => v(this.$el, "blur"), !0, e => !this.$el.contains(e.target)), m(this.mode, "click") && (this._preventClick = !0))
                }
            }, {
